...
import Rectangle7 from '../assets/pictures/Rectangle7.png'
...
const Hiring1 = () => {
  ...
  return (
    <div className='sm:flex sm:p-11  sm:space-x-12 grid grig-col-1'>
            ...
            <img src={Rectangle7} alt="" className='duration-500 ease-in-out sm:mb-0 mb-12 transform hover:-translate-y-1 hover:scale-105 sm:w-[53%] w-full sm:h-full '/>
