...
import Rectangle38 from '../assets/pictures/Rectangle38.png';
            ...
            <div className='bg-black h-[90vh] sm:h-[110vh]'>
                ...
                <div className='bg-black md:py-6 md:px-9 bg-opacity-5 relative flex justify-between items-center text-white'>
                    ...
                    <div className='space-x-10 text-sm hidden sm:flex md:flex'>
                        {navItems.map((item, index) => (
                            <Link className='hover:text-underline' key={index} to={item.href}>{item.label}</Link>
                        ))}
                    </div>
                ...
                <div className='bg-opacity-5 text-white'>
                    ...
                    <p className='md:px-16 md:text-lg py-5 md:py-0 px-3 text-sm md:tracking-widest bg-opacity-5 relative md:w-[75%]'>
                        Lorem ipsum dolor sit amet consectetur. Leo id bibendum aliquam eget.                        Lorem ipsum dolor sit amet consectetur. Leo id bibendum aliquam eget.
